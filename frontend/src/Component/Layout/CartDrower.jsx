...
const CartDrower = ({ drawerOpen, toggleCartDrawer }) => {
  return (
    ...
    >
      ...
      {/* cart content with scrolable are */}
      ...
      <div className="flex-grow p-4 overflow-y-auto">
        ...
        <div className="p-4 bg-white sticky bottom-0">
            ...
            <p className="text-sm tracking-tighter text-gray-500 mt-2 text-center">Shipping , taxes, and discount codes calculated at checkout.
            </p>
        </div>
    </div>
  );
